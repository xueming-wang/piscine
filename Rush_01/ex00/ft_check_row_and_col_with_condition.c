...
int		ft_check_raw_left_with_condition(int raw, int tab[4][4], int *condition)
{
	int number_bigger;
	int condition_adapt;
	int number_actuel;
...
int		ft_check_raw_right_with_condition(int raw, int tab[4][4], int *condition)
{
	int number_bigger;
	int condition_adapt;
	int number_actuel;
...
int		ft_check_col_up_with_condition(int col, int tab[4][4], int *condition)
{
	int number_bigger;
	int condition_adapt;
	int number_actuel;
...
int		ft_check_col_down_with_condition(int col, int tab[4][4], int *condition)
{
	int number_bigger;
	int condition_adapt;
	int number_actuel;
